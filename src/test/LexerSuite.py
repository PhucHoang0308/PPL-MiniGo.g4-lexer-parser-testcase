...
class LexerSuite(unittest.TestCase):
    ...
    def test_inline_comment(self):
        """test inline-comment"""
        self.assertTrue(TestLexer.checkLexeme("//test ","<EOF>",106))
    ...
    def test_illegal_esacpe(self):
        """illegal_escape"""
        self.assertTrue(TestLexer.checkLexeme(""" "test \\f" ""","""Illegal escape in string: "test \\f""", 129))
        
    def test_illegal_esacpe_1(self):
        """illegal_escape"""
        self.assertTrue(TestLexer.checkLexeme(""" "test \\b" ""","""Illegal escape in string: "test \\b""", 130))
    ...
    def test_illegal_identifiers_2(self):
        """illegal_identifiers"""
        self.assertTrue(TestLexer.checkLexeme("$test ","ErrorToken $", 133))
    ...
    def test_unclose_string_2(self):
        """test unclose string"""
        self.assertTrue(TestLexer.checkLexeme(""" "Dep trai\r ""","""Unclosed string: "Dep trai
 """,141))
    ...
    def test_newline_1(self):
        """test newline"""
        self.assertTrue(TestLexer.checkLexeme("""const a = "test "
                                              ""","const,a,=,\"test \",;,<EOF>",155))
    ...
    def test_wrong_token_2(self):
        """test wrong token"""
        self.assertTrue(TestLexer.checkLexeme("""abc,#test ""","abc,,,ErrorToken #",173))
    ...
    def test_wrong_token_4(self):
        """test wrong token"""
        self.assertTrue(TestLexer.checkLexeme(""" test  `""","test,ErrorToken `",175))
    ...
    def test_string_literal_6(self):
        """test array literal"""
        self.assertTrue(TestLexer.checkLexeme(""" "test  \\t" ""","\"test  \\t\",<EOF>",177))
        
    def test_string_literal_7(self):
        """test array literal"""
        self.assertTrue(TestLexer.checkLexeme(""" "test  \\r" ""","\"test  \\r\",<EOF>",178))
        
    def test_string_literal_8(self):
        """test array literal"""
        self.assertTrue(TestLexer.checkLexeme(""" "test  \\" " """,""""test  \\" ",<EOF>""",179))
    ...
    def test_inline_comment_2(self):
        """test inline comment"""
        self.assertTrue(TestLexer.checkLexeme("""//test  //test  // wibu""","<EOF>",182))
        
    def test_inline_comment_3(self):
        """test inline comment"""
        self.assertTrue(TestLexer.checkLexeme("""//test  /*Brother*/""","<EOF>",183))
